...
void setup() {
  ...
  // Legacy method
  // si4844.setCustomBand(40,27000,27500,5);  // Set band to work between 27.0 to 27.5 MHz

  // New Method
  si4844.addCustomBand(40, 27000, 27500, 5); // Register band to work between 27.0 to 27.5 MHz
  si4844.setBand(40);
